...
<a class="normalmatter" style="text-decoration:none;" href="gastrosurgery.jsp">
      Overview
    </a></td><td> &nbsp; </td>
	<td id="general_info" class="normalmatter">
	<a class="normalmatter" style="text-decoration:none;" href="gas_doctor.jsp">
      Doctors
    </a></td><td> &nbsp; </td></tr>
	<tr>
