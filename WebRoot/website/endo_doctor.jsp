...
<a class="normalmatter" style="text-decoration:none;" href="endoscopic.jsp">
      Overview
    </a></td><td> &nbsp; </td>
	<td id="general_info" class="normalmatter">
	<a class="normalmatter" style="text-decoration:none;" href="endo_doctor.jsp">
      Doctors
    </a></td><td> &nbsp;</td></tr>
	<tr>
