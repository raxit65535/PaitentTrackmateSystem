...
<html>
  <head>
    ...
    <title>My JSP 'DisplayTag_searchAppointmentRequest.jsp' starting page</title>
  ...
  <body>
   ...
   <div  id="dp">
    <display:table  id="data" name="sessionScope.data" requestURI="/search_AppointmentRequest.do" pagesize="100" export="true" >
    ...
    <display:column  title="Accept"  sortable="true"><a href="appointmentAccept.jsp?${data.id}">Accept</a> </display:column>
     <display:column  title="Reject"  sortable="true"><a href="appointmentReject.jsp?${data.id}">Reject</a> </display:column>
