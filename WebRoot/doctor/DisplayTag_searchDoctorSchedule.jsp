...
<html>
  <head>
    ...
    <title>My JSP 'DisplayTag_searchDoctorSchedule.jsp' starting page</title>
  ...
  <body>
   ...
   <div  id="dp"> 
   <display:table  id="data" name="sessionScope.data" requestURI="/search_DoctorSchedule.do" pagesize="100" export="true" >
