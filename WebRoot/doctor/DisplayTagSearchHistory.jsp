...
<html>
  ...
  <div id="dp">
   <display:table  id="data" name="sessionScope.data" requestURI="/searchHistory.do" pagesize="100" export="true" >
	...
	<display:column  title="View"  sortable="true"><a href="viewDC.jsp?${data.id}" target="_blank">View</a> </display:column>
