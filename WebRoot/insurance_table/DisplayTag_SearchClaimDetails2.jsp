...
<html>
  <head>
    ...
    <title>Rejected Claim Request</title>
  ...
  <div id="dp">
	 ...
	 <display:table  id="data" name="sessionScope.data" requestURI="/search_ClaimDetails2.do" pagesize="100" export="true" >
	...
	<display:column  title="ACCEPT"  sortable="true" media="html"><a href="insurance_table/Accept.jsp?${data.id}">Accept</a> </display:column>
