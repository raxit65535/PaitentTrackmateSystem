...
<html> 
	<head>
		<title>JSP for Search_DischargeHistoryForm form</title>
<link rel="stylesheet" href="../css/screen.css" type="text/css" media="screen" title="default" />
	...
	<%@ include file="Temp.jsp"%>
		   ...
		   <div id="search" >
		<html:form action="/searchDischargeHistory">
	...
	<display:column  title="View"  sortable="true" media="html"><a href="paitent/viewDC.jsp?${data.id}" target="_blank">View</a> </display:column>
